...
class productsDaoMongo {
    ...
    try{
        let {title,description,code,price,status,stock,category,owner,thumbnails} = productData
        const product = await productsModel.create({title,description,code,price,status,stock,category,owner,thumbnails});
        if (!product) {
